...
namespace HW3Tests
{
    ...
    public class HW3Tests
    {
        ...
        public void FibonacciTest()
        {
            ...
            string firstThirteenNumbers = "1: 0\r\n2: 1\r\n3: 2\r\n4: 3\r\n5: 5\r\n6: 8\r\n7: 13\r\n8: 21\r\n9: 34\r\n10: 55\r\n11: 89\r\n12: 144\r\n13: 233\r\n";

            Assert.AreEqual(firstTwentyFibNumbers, testFibTextReaderTwenty.ReadToEnd());
            Assert.AreEqual(firstTwentyFibNumbers, testFibTextReaderFive.ReadToEnd());
            Assert.AreEqual(firstTwentyFibNumbers, testFibTextReaderThirteen.ReadToEnd());
            Assert.Pass();
        }
